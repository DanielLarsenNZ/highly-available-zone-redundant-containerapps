...
@description('The SQL DB connection string the ordering api will use')
@secure()
param orderingDbSecret string
...
@description('The name of the queue that this container app will send messages to')
...
resource containerAppServiceBusRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(serviceBus.id, containerApp.id, roleDefinitionIds.servicebus)
  scope: serviceBus
  properties: {
